...
export class BaseDataService {
  ...
  getUserData(userId: number){
    return this.http.get(`api/user/${userId}/with-selected-fields?selectedFields=Id,Name,Surname,Avatar`,
      {observe: 'body'})
      .subscribe((value:any) => {
  ...
  getEventData(eventId: number){
    return this.http.get(`api/event/${eventId}/with-selected-fields?selectedFields=Id,Title,Avatar`,
      {observe: 'body'})
      .subscribe((value:any) => {
