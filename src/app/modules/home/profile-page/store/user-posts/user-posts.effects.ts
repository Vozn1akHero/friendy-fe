...
import {switchMap, catchError, map, tap, withLatestFrom, concatMap, exhaustMap} from 'rxjs/operators';
import { of } from 'rxjs';
...
export class UserPostsEffects {
  ...
  profilePageAddPost = this.actions$.pipe(
    ...
    exhaustMap((addPostStart: UserPostsActions.AddPost) => {
  ...
  profilePageRemovePost = this.actions$.pipe(
    ...
    exhaustMap((payload: UserPostsActions.RemovePostStart) => {
