...
export const GET = "[Sent Friend Requests] Get";
export const SET = "[Sent Friend Requests] Set";
export const FIND_BY_KEYWORD = "[Sent Friend Requests] Find By Keyword";
export const SET_FOUND = "[Sent Friend Requests] Set Found";
export const FILL_FOUND_BY_KEYWORD =
  "[Sent Friend Requests] Fill Found By Keyword";
export const FILL_FOUND_BY_KEYWORD_IN_STATE =
  "[Sent Friend Requests] Fill Found By Keyword In State";
