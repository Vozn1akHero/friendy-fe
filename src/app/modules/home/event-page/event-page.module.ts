...
import { EventHeaderEventinfoComponent } from './components/event-header/event-header-eventinfo/event-header-eventinfo.component';
...
import { EventAvatarComponent } from './components/event-header/event-header-eventinfo/event-avatar/event-avatar.component';
...
import { EventPageSettingsComponent } from './components/event-page-settings/event-page-settings.component';
