...
export default class CommentResponseService {
  ...
  getAllByCommentId(commentId: number) {
    return this.http
      .get(`api/comment-response/all/${commentId}`, { observe: "body" })
      .pipe(
        map((res: any) => {
  ...
  like(id: number) {
    return this.http
      .post(`api/comment-response/like/${id}`, {}, { observe: "body" })
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  unlike(id: number) {
    return this.http
      .delete(`api/comment-response/unlike/${id}`, { observe: "body" })
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  delete(id: number) {
    return this.http
      .delete(`api/comment-response/${id}`, { observe: "body" })
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  create(commentResponse: NewCommentResponseModel) {
    return this.http
      .post(`api/comment-response`, commentResponse, { observe: "body" })
      .pipe(
        map((res: any) => {
  ...
  createResponseToResponse(responseToResponse: NewResponseToResponseModel) {
    return this.http
      .post(`api/comment-response/to-response`, responseToResponse, {
        observe: "body"
      })
      .pipe(
        map((res: any) => {
